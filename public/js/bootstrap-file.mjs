...
// Embed expanded default playlist index for file:// builds.
// This file is generated by build-file.mjs so we don't need fetch() to infer metadata.
import defaultPlaylistIndex from '../video/default-playlists-expanded.json';
try {
